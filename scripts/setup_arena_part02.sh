...
cp -rf ../scripts/data/app/config/cors.php ./app/config/cors.php
...
cp -rf ../scripts/data/app/Http/Controllers/AuthController.php ./app/Http/Controllers/AuthController.php
./vendor/bin/sail artisan make:middleware IsAdmin
cp -rf ../app/Http/Middleware/IsAdmin.php/scripts ./app/Http/Middleware/IsAdmin.php
